...
/**This Class was created to represent an airport for the NetworkGraph Class.
 * It carries an average cost so it can be used with Dijkstra's algorithm to find
 * the cheapest path.
 * 
...
public class AirportVertex implements Comparable<AirportVertex> {
	...
	/**Constructor of Airport vertex, which takes in a name and cost is initialized at
	 * at a max value. The cost is initialized at max value because that way when we 
	 * the set the first cost, it will be automatically lower than the original cost.
	 * 
	 * @param airport - name of airport to be constructed
	 */
	...
	/**This method adds a flight to the ArrayList of flights in the airport if it is
	 * not already contained.
	 * 
	 * @param flight - a flight edge to be added to the airport vertex
	 */
	 ...
	 * 
	 * @param flight - a flight edge to see if it is contained in the airport vertex
	...
	/**Returns the specific flight edge object contained to this airport vertex, in order
	 * to update costs on the correct flight when importing data, or retrieving data from 
	 * the correct edge.
	 * 
	 * @param flight - flight edge object.
	 * @return flight - flight edge object contained in the airport vertex object.
	 */
	 ...
	 * 
	 * @param _previous - previous airport visited.
	 */
	...
	/**This method retrieves the previously visited Airport Vertex. Can
	 * return null if previous AirportVertex has not been visited.
	 * 
